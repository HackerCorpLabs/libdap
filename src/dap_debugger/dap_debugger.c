...
const DebuggerCommand commands[] = {
    ...
    },
    {
        .name = "break",
        .alias = "b",
        .syntax = "break [<file:line> | <line> [file]]",
        .description = "Set breakpoint at line or list all breakpoints if no args provided",
        ...
        .option_descriptions = "Line number and optional file path",
        .examples = "break|List all breakpoints|break 42|Set breakpoint at line 42 in current file|break file.c:42|Set breakpoint at line 42 in file.c|break 42 file.c|Set breakpoint at line 42 in file.c",
